        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <span className="text-gray-300 text-sm">Consultoría Empresarial</span>
              </li>
              <li>
                <span className="text-gray-300 text-sm">Comercio Internacional</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © Copyright 2025 Cámara de Comercio de San Rafael - Todos los derechos reservados
            </p>
